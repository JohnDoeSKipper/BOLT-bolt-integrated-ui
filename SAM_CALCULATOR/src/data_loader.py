"""
Data loader — normalises load-profile files into a common 5-column schema:
    ['timestamp', 'kw_import', 'kw_export', 'kvar_import', 'kvar_export']
Supports: CSV, XLSX/XLS (all 4 competition formats).
"""
...
def load_csv(path: str | Path) -> pd.DataFrame:
    ...
    if ts_col is None:
        ts_col = df.columns[0]
    return _standardize(df, _clean_col(ts_col))
